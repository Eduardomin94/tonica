...
age_35_44: "35 a 44 años",
    ...
    // background / scene
    backgroundTitle: "8) Fondo (máx 100 palabras)",
    helpChoosePlace: "Ayudame a elegir",
    searching: "Buscando...",
    sceneTitle: "Escena del producto (máx 100 palabras)",
    ...
    errSceneMissing: "Escribí la escena (máx 100 palabras).",
    errSceneTooLong: "La escena puede tener hasta 100 palabras como máximo.",
    ...
    errBgMissing: "Escribí el fondo (máx 100 palabras).",
    errBgTooLong: "El fondo puede tener hasta 100 palabras como máximo.",
...
exampleCm: "e.g. 52cm",
    ...
    backgroundTitle: "8) Background (max 100 words)",
    helpChoosePlace: "Help me pick",
    searching: "Searching...",
    sceneTitle: "Product scene (max 100 words)",
    ...
    errSceneMissing: "Write the scene (max 100 words).",
    errSceneTooLong: "Scene must be max 100 words.",
...
footerAnd: "and",
    ...
    errBgMissing: "Write the background (max 100 words).",
    errBgTooLong: "Background can have up to 100 words maximum.",
...
exampleCm: "Ex: 52cm",
  ...
  // background / scene
  backgroundTitle: "8) Fundo (máx. 100 palavras)",
  helpChoosePlace: "Me ajude a escolher",
  searching: "Buscando...",
  sceneTitle: "Cena do produto (máx. 100 palavras)",
  ...
  errSceneMissing: "Escreva a cena (máx. 100 palavras).",
  errSceneTooLong: "A cena deve ter no máximo 100 palavras.",
  ...
  errBgMissing: "Escreva o fundo (máx. 100 palavras).",
  errBgTooLong: "O fundo pode ter no máximo 100 palavras.",
...
exampleCm: "예: 52cm",
  ...
  backgroundTitle: "8) 배경(최대 100단어)",
  helpChoosePlace: "추천 받기",
  searching: "검색 중...",
  sceneTitle: "제품 장면(최대 100단어)",
  helpChoose: "추천 받기",
  ...
  errSceneMissing: "장면을 입력하세요(최대 100단어).",
  errSceneTooLong: "장면은 최대 100단어입니다.",
  errModel: "모델 유형을 선택하세요.",
  errEthnicity: "인종/피부톤을 선택하세요.",
  errAge: "나이를 선택하세요.",
  errPose: "포즈를 선택하세요.",
  errBodyType: "체형을 선택하세요.",
  errBgMissing: "배경을 입력하세요(최대 100단어).",
  errBgTooLong: "배경 설명은 최대 100단어까지 가능합니다.",
...
exampleCm: "例如：52cm",
  ...
  backgroundTitle: "8) 背景（最多 100 个词）",
  helpChoosePlace: "帮我推荐",
  searching: "搜索中...",
  sceneTitle: "产品场景（最多 100 个词）",
  helpChoose: "帮我推荐",
  modelNewborn: "新生儿",
  modelBoy: "男孩",
  modelGirl: "女孩",
  ...
  errSceneMissing: "请输入场景（最多 100 个词）。",
  errSceneTooLong: "场景最多 100 个词。",
  errModel: "请选择模特类型。",
  errEthnicity: "请选择人种/肤色。",
  errAge: "请选择年龄。",
  errPose: "请选择姿势。",
  errBodyType: "请选择体型。",
  errBgMissing: "请输入背景（最多 100 个词）。",
  errBgTooLong: "背景描述最多可包含100个单词。",
